...
Axiom eq_real_term_real :
  forall (r1:real_number) (r2:real_number), eq_real_number r1 r2 ->
  eq_real_term (Real r1) (Real r2).

Axiom eq_real_term_mean :
  forall (p1:population) (p2:population), eq_population p1 p2 ->
  eq_real_term (mean p1) (mean p2).

Axiom eq_real_term_var :
  forall (p1:population) (p2:population), eq_population p1 p2 ->
  eq_real_term (var p1) (var p2).

Axiom eq_real_term_med :
  forall (p1:population) (p2:population), eq_population p1 p2 ->
  eq_real_term (med p1) (med p2).
...
Axiom Eq_variance_same_var :
  forall (m:real_number) (n:real_number) (v:real_number),
  eq_variance (NormalD m v) (NormalD n v).
...
Fixpoint combinations (lst:Init.Datatypes.list term)
  ...
  | Init.Datatypes.cons x tl =>
      combinations tl (Init.Datatypes.app acc (aux x tl pred)) pred
  end.
